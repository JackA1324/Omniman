...
function preload() {
  bgVideo = createVideo('img/frame4.mp4');
  myFont = loadFont('font/KdamThmorPro-Regular.ttf');
  sound1 = loadSound('sound/7.mp3');
  sound2 = loadSound('sound/8.mp3');
}
...
//google ai overview helped me find this cool function called scrubTime. It maps where the mouse is and changes my bgVideo duration as the mouse grazes the screen.
  ...
  // Trigger second text & show zoom effect when mouse enters the right half
  ...
  if (showSecondText) {
    ...
    strokeWeight(4);
    textSize(96);
    text("How could\nyou see that", width / 1.7, height / 1.2);
  }
