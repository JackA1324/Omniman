...
function preload() {
  bgVideo = createVideo('img/frame7.mp4');
  myFont = loadFont('font/KdamThmorPro-Regular.ttf');
  sound1 = loadSound('sound/11.mp3');
...
//google ai overview helped me find this cool function called scrubTime. It maps where the mouse is and changes my bgVideo duration as the mouse grazes the screen.
  ...
  text("I'll be ductape man!", width / 25, height / 9);
  ...
  if (showSecondText) {
    textSize(96);
    let dots = ".......".substring(7 - floor(frameCount/20) % 7);
    text("" +dots, width / 1.3, height / 1.1);
  }
